...
class SettingsViewModel @Inject constructor(
    ...
    var _settingsData = MutableLiveData<SettingsData>()
    ...
    private fun loadSettingsSections() {
        ...
        val generalItems = mutableListOf<ClickableItem>().apply {
            add(ClickableItem(String.format(generalStrings[0], baseFiat.value?.name, baseFiat.value?.rate), println("Clicked 0!")))
        ...
        val aboutItems = mutableListOf<ClickableItem>().apply {
            ...
            add(ClickableItem(aboutStrings[3], println("Clicked 3!")))
        }
